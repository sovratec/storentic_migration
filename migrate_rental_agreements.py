...
Usage (standalone):
    python migrate_rental_agreements.py --file data/CustomerUnitSample.xlsx --output db
    python migrate_rental_agreements.py --file data/CustomerUnitSample.xlsx --output db --dry-run
    python migrate_rental_agreements.py --file data/CustomerUnitSample.xlsx --output db --update
    python migrate_rental_agreements.py --file data/CustomerUnitSample.xlsx --output excel

Usage (via unified entry point — preferred):
    python migrate.py --type rental_agreement --file data/CustomerUnitSample.xlsx [--output db|excel] [--dry-run] [--update]
